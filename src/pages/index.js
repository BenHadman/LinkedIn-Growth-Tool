...
const features = [
    ...
    description: (
      <>
        ...
        <p>
          ...
          and an <a href="/blobfish">industry leading mascot</a>.
        </p>
      </>
    )
  },
  {
    ...
    description: (
      <>
        <p>
          Benthos is able to glue a wide range of{" "}
          <a href="/docs/components/inputs/about">sources</a> and{" "}
          <a href="/docs/components/outputs/about">sinks</a> together and hook
          into a variety of{" "}
          <a href="/docs/components/processors/sql">databases</a>,{" "}
          <a href="/docs/components/processors/cache">caches</a>,{" "}
          <a href="/docs/components/processors/http">HTTP APIs</a>,{" "}
          <a href="/docs/components/processors/aws_lambda">lambdas</a> and{" "}
          <a href="/docs/components/processors/about">more</a>, enabling you to
          seamlessly drop it into your existing infrastructure.
        </p>
        <p>
          Working with disparate APIs and services can be a daunting task,
          doubly so in a streaming data context. With Benthos it's possible to
          break these tasks down and automatically parallelize them as{" "}
          <a href="/cookbooks/enrichments">a streaming workflow</a>.
        </p>
      </>
    )
  },
  {
    ...
    description: (
      <>
        <p>
          Benthos runs fast and processes messages using a transaction model,
          making it able to guarantee at-least-once delivery even in the event
          of crashes, disk corruption, or other unexpected server faults.
        </p>
        <p>
          It's completely stateless with no need for disk persisted state,
          allowing for easy deployment and liberal scaling. It also exposes{" "}
    ...
    description: (
      <>
        ...
        <p>
          ...
          <a href="https://pkg.go.dev/github.com/Jeffail/benthos/v3/public">
            directly in Go (recommended)
          </a>{" "}
          or you can have Benthos run your plugin as a{" "}
        ...
        <div className="container">
          <div className="row">
            ...
            <div className={classnames("col col--5")}>
              <img className={styles.heroImg} src="img/banner.png" />
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="row">
            <div className={classnames(`${styles.pitch} col col--6`)}>
              ...
              <p>
                Written in Go, deployed as a static binary, declarative
                configuration.{" "}
                <a href="https://github.com/Jeffail/benthos">Open source</a> and
                cloud native as utter heck.
              </p>
              {installs && installs.length && (
                <Tabs
                  defaultValue={installs[0].label}
                  values={installs.map((props, idx) => {
              ...
              <div className={classnames("col col--6")}>
                ...
                >
                  <img
                    ...
                    src="/img/sponsors/mw_logo.png"
                  />
                </a>
                <a
                  href="https://www.humansecurity.com"
                  className={styles.sponsorLink}
                >
                  <img
                    className={styles.humanImg}
                    src="/img/sponsors/HUMAN_logo.png"
                  />
                </a>
                <a
                  href="https://www.infosum.com/"
                  className={styles.sponsorLink}
                >
                  <img
                    className={styles.infosumImg}
                    src="/img/sponsors/infosum_logo.png"
                  />
                </a>
                <a href="https://community.com/" className={styles.sponsorLink}>
                  <img
                    className={styles.communityImg}
                    src="/img/sponsors/community.svg"
                  />
                </a>
              </div>
